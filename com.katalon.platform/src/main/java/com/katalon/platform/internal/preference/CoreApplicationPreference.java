...
public final class CoreApplicationPreference implements ApplicationPreference {

    private final CoreApplicationPreferenceStore preferenceStore;

    private final String pluginId;

    public CoreApplicationPreference(String pluginId) {
        this.pluginId = pluginId;
        this.preferenceStore = new CoreApplicationPreferenceStore(pluginId);
    }
    ...
    public boolean getBoolean(String key, boolean defaultValue, boolean shouldDecrypt)
        ...
        try {
            return Boolean.valueOf(CryptoUtil.decode(CryptoUtil.getDefault(rawValue)));
        } catch (GeneralSecurityException | IOException e) {
            throw new CryptoException(e);
        }
    }
